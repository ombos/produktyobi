...
<div class="row">
	<div class="col-md-12 notAccepted">
		<i class="fa fa-exclamation-triangle" aria-hidden="true" style="font-size: 20px; margin-right: 15px;"></i> Masz <strong><?php echo count($products); ?></strong> produkty z nieuzupełnionymi / niezaakceptowanymi danymi logistycznymi.
	</div>
