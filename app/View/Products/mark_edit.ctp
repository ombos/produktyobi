			...
			<div class="container">
				<div rds-wrapper rds-wrapper-loading="loading" rds-wrapper-message="message" rds-wrapper-message-type="'danger'">
					<div app-products ng-init="errorMessage = '<?php echo Consts::$faultMessage; ?>'">
						...
						>
							<?php echo $this->Form->create('ObiMark', array(
									'ajax' => true,
									'validationUrl' => 'obi_marks/validate_add',
							...
							<?php echo $this->Form->input('ObiMark.id', array(
								'value' => $markData['ObiMark']['id']
							)); ?>
							
							<h2>Edytuj markę: <?php echo $markData['ObiMark']['name']; ?></h2>
							
							<div class="row">
								<div class="col-xs-12">
									
									<?php echo $this->Form->input('ObiMark.name', array(
										'type' => 'text',
										'label' => 'Nazwa',
										'class' => 'input_search',
										'placeholder' => 'Wpisz nazwę marki',
										'value' => $markData['ObiMark']['name']
									)); ?>
								</div>	
								<div class="col-xs-12">
