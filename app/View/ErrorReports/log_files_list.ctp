    ...
    <div class="view-wrapper">
        ...
        <div class="content">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <h1><?php echo __('Log files list'); ?></h1>
                        ...
                        >
                            <div
                                class="advanced-list"
                                rds-list
                                rds-list-url="/error_reports/filter_log_files_list"
                                ...
                                <table ng-show="files">
                                    ...
                                    <tbody ng-repeat="file in files">
                                        <tr>
                                            ...
                                            <td>{{file.modified}}</td>
                                            <td>
                                                <?php echo $this->Html->link('<i class="fa fa-eye"></i>', '/error_reports/view/{{file.name}}', array('class' => 'btn btn-success', 'escape' => false)); ?>
