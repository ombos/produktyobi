								...
								>
									<div class="filter-box">
										<div
											class="advanced-list"
											rds-list
											rds-list-url="/raports/filter_logistic"
										...
										<div class="row">
											<div class="col-xs-4">
												<?php echo $this->Form->input('ObiReport.reporttype', array(
													'type' => 'select',
													'options' => array(
														1 => 'Produkty bez wszystkich danych logistycznych',
														2 => 'Produkty niezawierające żadnych mediów',
														3 => '??? Produkty z częściowo uzupełnionymi danymi logistycznymi',
														4 => '??? Produkty zawierające wszystkie dane logistyczne',
														5 => '??? Produkty zawierające media'
													),
													'empty' => 'wybierz zakres danych',
													'label' => 'Wybierz zakres danych',
													'class' => 'input_filter',
													'rds-list-filter' => 'ObiReport.reporttype',
													'rds-list-filter-value' => 'reportType',
													'ng-model' => 'reportType',
												)); ?>
											</div>
										...
										<div ng-show="products">
											<p>Liczba produktów: xxx <button type="button" class="btn btn-success" style="margin-left: 100px" ng-click="exportLogistic(reportType, supplier)"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Eksportuj do excela</button></p><br/><br/><br/>
											<table>
												<thead>
													<tr>
														<th></th>
