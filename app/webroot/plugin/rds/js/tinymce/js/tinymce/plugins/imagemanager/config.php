<?php
	...
	$mcImageManagerConfig['preview.urlprefix'] = "http://sportsystem.gravitan.pl/"; // domain name
	$mcImageManagerConfig['preview.urlsuffix'] = "images/products/thumbs/";
	...
	$mcImageManagerConfig['filesystem.rootpath'] = '/images/products/thumbs/'; // absolute or relative from this script path, required.
